...
public class SoccerDatabase implements SoccerDB {
    ...
    public boolean removePlayer(String firstName, String lastName) {
        return database.remove(getKey(firstName, lastName)) != null;
    }
    ...
    public SoccerPlayer getPlayer(String firstName, String lastName) {
        return database.get(getKey(firstName, lastName));
    }
    ...
    public int numPlayers(String teamName) {
        ...
        int count = 0;
        for (Enumeration<String> e = database.keys(); e.hasMoreElements();) {
            SoccerPlayer player = database.get(e.nextElement());
    ...
    public boolean readData(File file) {
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                database.put(getKey(firstName, lastName), player);
            }
